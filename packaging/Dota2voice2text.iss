...
UninstallDisplayIcon={app}\Dota2voice2text-v0.3.3.ico
...
Source: "..\assets\icons\app_icon.ico"; DestDir: "{app}"; DestName: "Dota2voice2text-v0.3.3.ico"; Flags: ignoreversion
[Icons]
Name: "{group}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; IconFilename: "{app}\Dota2voice2text-v0.3.3.ico"
Name: "{autodesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; IconFilename: "{app}\Dota2voice2text-v0.3.3.ico"; Tasks: desktopicon
